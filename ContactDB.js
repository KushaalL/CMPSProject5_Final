...
class ContactDB {
    ...
    async createContact(info)
    {
        return await this.db.create('Contacts',[
            ...
            {column: 'street', value: info.street},
            {column: 'city', value: info.city},
            {column: 'state', value: info.state},
            {column: 'country', value: info.country},
            {column: 'zipcode', value: info.zipcode},
